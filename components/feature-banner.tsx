export function FeatureBanner() {
  return (
    <section 
      className="relative z-20 py-32 bg-[#07030A] overflow-hidden -mt-[60px] pb-32 border-t-2 border-[#FF66FF]"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-tr from-[#FF66FF]/10 to-blue-900/20 mix-blend-screen"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-1/2 relative flex justify-center mb-10 lg:mb-0 group">
          <div className="w-80 h-80 bg-gradient-to-tr from-[#07030A] to-blue-900/50 border border-[#FF66FF]/50 transform rotate-6 flex items-center justify-center shadow-[0_0_30px_rgba(230,57,70,0.3)] transition-transform duration-500 group-hover:rotate-12">
        ...
        <div className="w-full lg:w-1/2 text-right">
          <p className="text-[#FF66FF] font-bold tracking-[0.2em] text-sm mb-2 uppercase drop-shadow-[0_0_5px_rgba(230,57,70,0.8)]">
          ...
          <div className="inline-block text-left bg-[#07030A]/90 p-8 backdrop-blur-md max-w-md border-l-4 border-[#FF66FF] shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            <h3 className="text-white text-2xl font-black tracking-widest mb-2">+ RENGEKI</h3>
            <p className="text-[#C167FF] font-bold tracking-[0.2em] text-xs mb-4 uppercase">ROGUE SHINOBI // LIGHTNING BLADE</p>
            <p className="text-[#FDEEEB]/80 text-sm mb-6 leading-relaxed">
            ...
            <button className="bg-[#FF66FF] text-white px-8 py-3 font-black tracking-wider text-sm hover:bg-white hover:text-[#FF66FF] transition-colors skew-x-[-10deg]">
