        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="h-px w-8" style={{ background: "linear-gradient(to right, transparent, #9F8AFF)" }} />
            ...
            <p className="mt-3 text-sm" style={{ color: "rgba(176,176,204,0.6)" }}>
              {filtered.length} event{filtered.length !== 1 ? "s" : ""} &middot; May 14&ndash;15, 2026
            </p>
          </div>
            ...
            return (
              <article
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.borderColor = `${cat?.accentColor}50`;
                  el.style.boxShadow = `0 16px 40px ${cat?.accentColor}12`;
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  {/* Category chip */}
                  <div
                    className="absolute top-4 left-4 z-20 flex items-center gap-1.5 px-2.5 py-1"
                    style={{
                  ...
                  {/* Date chip */}
                  <div
                    className="absolute top-4 right-4 z-20 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest"
                    style={{
                      background: "rgba(5,5,5,0.75)",
                      backdropFilter: "blur(8px)",
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3
                    className="text-xl font-black tracking-tight leading-tight mb-1.5"
                    style={{ color: "#fff", transition: "color 0.2s ease" }}
                    onMouseEnter={(e) => (e.currentTarget as HTMLHeadingElement).style.color = "#C167FF"}
                  ...
                  <a
                    href="#"
                    className="mt-auto flex items-center justify-between text-xs font-bold uppercase tracking-widest py-3 px-4"
                    style={{
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.borderColor = `${cat?.accentColor}60`;
                      el.style.color = cat?.accentColor || "#C167FF";
